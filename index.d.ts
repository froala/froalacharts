...
declare namespace FroalaCharts {
    ...
    interface FroalaCharts {
        ...
        render(containerElement?: string | Element, insertMode?: string, callback?: () => any): FroalaCharts;
    ...
    interface FroalaChartStatic {
        new (chartObject: ChartObject|{}): FroalaCharts;

        (chartId: string): FroalaCharts;
        ...
        ready(callback: (froalaChartStatic?: FroalaChartStatic) => any, context?: any): FroalaChartStatic;
        ...
        render(options?: ChartObject, callback?: () => any): FroalaCharts;
...
declare var FroalaCharts: FroalaCharts.FroalaChartStatic;
export = FroalaCharts;
export as namespace FroalaCharts;